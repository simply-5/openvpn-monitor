...
```
Also, if selinux is enabled the following changes are required:
...
# yum -y install python3-virtualenv geolite2-city                       # (centos/rhel)
...
```shell
yum -y install git httpd mod_wsgi python3-geoip2 python3-humanize python3-bottle python3-semantic_version geolite2-city
...
# yum -y install git gcc nginx uwsgi uwsgi-plugin-python3 virtualenv python3-devel geoip-devel geolite2-city                       # (centos/rhel)
```
